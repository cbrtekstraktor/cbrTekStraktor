...
public class cmcProcEnums {
	...
	public enum MENU_ITEMS {
		 ...
		 DIV2 , INFO , REFRESH , 
		 DIV3 , IMPORT , EXPORT , 
		 DIV4 , PROPERTIES_START , GENERAL_PROPERTIES , EDIT_OPTIONS , TESSERACT_OPTIONS , PROPERTIES_STOP ,  
	...
	public enum PROJECT_LABEL { ROOT_FOLDER , PROJECT_NAME , DESCRIPTION , MEAN_CHARACTER_COUNT , HORIZONTAL_VERTICAL_VARIANCE_THRESHOLD , TESSERACT_FOLDER , 
